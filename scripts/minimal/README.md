...
3. 保存所有日志到 `scripts/minimal/results/logs/`
...
下一步:
  如果结果满意，运行: bash scripts/minimal/upgrade_to_standard.sh
```
...
rm -rf scripts/minimal/data/*/host_*          # 删除生成的宿主 reads
rm -rf scripts/minimal/data/*/microbe_*       # 删除生成的微生物 reads
rm -rf scripts/minimal/results/*/work/        # 删除工作目录

# 保留:
# - scripts/minimal/results/performance.csv
# - scripts/minimal/results/accuracy.csv
# - scripts/minimal/results/*.png
```
