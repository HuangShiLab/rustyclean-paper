#!/bin/bash
#SBATCH --job-name=rustyclean_sylph_t2t_only
...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=/home/shihuang/rustyclean_sylph_t2t_only_%j.out
#SBATCH --error=/home/shihuang/rustyclean_sylph_t2t_only_%j.err
...
OUT=/scr/u/shihuang/rustyclean-paper/results_sylph_t2t_only
SYLPH_DB=/lustre1/g/aos_shihuang/databases/rustyclean_human_t2t_only/sylph/human_t2t.syldb
BT2_INDEX=/lustre1/g/aos_shihuang/databases/rustyclean_human_t2t_only/bowtie2/human_t2t
THREADS=8
REPS=3
...
METRICS="$OUT/metrics/performance_sylph_t2t_only.csv"
...
for ds in "${DATASETS[@]}"; do
  for rep in $(seq 1 $REPS); do
    ...
    echo "rustyclean_sylph_t2t_only,$ds,$rep,$runtime_sec,$mem_kb,$(date -Iseconds)" >> "$METRICS"
  done
done
