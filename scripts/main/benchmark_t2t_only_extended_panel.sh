...
#SBATCH --output=/home/%u/t2t_extended_panel_%j.out
#SBATCH --error=/home/%u/t2t_extended_panel_%j.err
...
RESULTS_DIR="${RUNS_DIR:-/lustre1/g/aos_shihuang/rustyclean-paper/runs}/t2t_only_extended_panel"
