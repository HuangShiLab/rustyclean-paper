...
#SBATCH --output=/home/shihuang/rc_auto_boundary_%j.out
#SBATCH --error=/home/shihuang/rc_auto_boundary_%j.err
...
RESULTS_DIR="/lustre1/g/aos_shihuang/rustyclean-paper/auto_decision_boundary"
