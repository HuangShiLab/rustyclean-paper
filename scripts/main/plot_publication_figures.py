...
#
# Usage: python scripts/main/plot_publication_figures_v2.py <results_dir> [output_dir]
# Example: python scripts/main/plot_publication_figures_v2.py ./results ./analysis/figures
