...
#
# Usage: bash scripts/main/run_benchmark.sh [data_dir] [output_dir]
...
echo ""
echo "Next steps:"
echo "  python scripts/main/analyze_accuracy.py $DATA_DIR $RESULTS_DIR"
echo "  python scripts/main/analyze_performance.py $RESULTS_DIR"
