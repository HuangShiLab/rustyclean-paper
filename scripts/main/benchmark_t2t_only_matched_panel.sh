#!/bin/bash
#SBATCH --job-name=t2t_matched_panel
...
#SBATCH --output=/home/%u/t2t_matched_panel_%j.out
#SBATCH --error=/home/%u/t2t_matched_panel_%j.err
...
RESULTS_DIR="${RUNS_DIR:-/lustre1/g/aos_shihuang/rustyclean-paper/runs}/t2t_only_matched_panel"
