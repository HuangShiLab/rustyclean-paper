...
#SBATCH --output=/home/shihuang/t2t_pe_panel_%j.out
#SBATCH --error=/home/shihuang/t2t_pe_panel_%j.err
...
RESULTS_DIR="/lustre1/g/aos_shihuang/rustyclean-paper/t2t_only_pe_panel"
