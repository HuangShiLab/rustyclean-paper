...
python "$REPO_DIR/scripts/benchmark/compute_accuracy_bowtie2_recheck_v2.py" \
    ${RUNS_DIR:-/lustre1/g/aos_shihuang/rustyclean-paper/runs}/bowtie2_recheck_v2 \
    ${RUNS_DIR:-/lustre1/g/aos_shihuang/rustyclean-paper/runs}/bowtie2_recheck_v2/metrics/accuracy_bowtie2_recheck.csv
