...
#
# Usage:
#     python scripts/generate_final_report.py [output_dir]
#
...
def generate_report(output_dir):
    ...
    if figures:
        report.append(
            ...
            f"`scripts/generate_publication_figures_v2.py` and saved to "
        ...
        report.append(
            ...
            "Run `scripts/generate_publication_figures_v2.py` first.*"
        )
        report.append("")
