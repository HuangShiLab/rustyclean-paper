...
python "$SCRIPT_DIR/../scripts/analyze_accuracy.py" "$DATA_DIR" "$RESULTS_DIR" "$ANALYSIS_DIR"

echo ""
echo "[2/4] Performance analysis..."
python "$SCRIPT_DIR/../scripts/analyze_performance.py" "$RESULTS_DIR" "$ANALYSIS_DIR"

echo ""
echo "[3/4] Publication figures..."
python "$SCRIPT_DIR/../scripts/plot_publication_figures.py" "$RESULTS_DIR" "$ANALYSIS_DIR/figures"

echo ""
echo "[4/4] Report generation..."
python "$SCRIPT_DIR/../scripts/generate_report.py" "$RESULTS_DIR" "$ANALYSIS_DIR/report.md"
